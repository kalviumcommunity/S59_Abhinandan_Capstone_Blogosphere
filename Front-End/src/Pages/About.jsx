...
import { Button, Checkbox, Label, TextInput, Blockquote } from 'flowbite-react';
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div className='flex justify-center items-center' style={{ height: "calc(100vh - 8vw)", width: "100vw", margin: "4vh 10vh 4vh 10vh" }}>
          {/* <div className='bg-blue-500 p-4 rounded text-gray-700 font-bold font-sans'>About</div> */}
          <div className='flex flex-col justify-center items-center'>

          <Blockquote className="my-4 border-l-4 border-gray-300 bg-gray-100 p-4 dark:border-gray-500 dark:bg-gray-800 mb-10 w-[50vw]">
